...
* 🕵️‍♂️ **[Claude Code Analyzer](https://github.com/shivamshinde123/Claude-Code-Analyzer)** : An agentic CLI harness that allows Claude to inhabit your terminal. It uses a custom toolset for file I/O, shell execution, and codebase navigation to autonomously analyze and refactor code.
